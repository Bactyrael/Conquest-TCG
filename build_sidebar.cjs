    ...
    <Xwrapper>
      <div className="game-container" style={{ display: 'flex', width: '100vw', height: '100vh', overflow: 'hidden' }}>
        <div className="game-board-area" style={{ flex: '1', position: 'relative', overflow: 'hidden' }}>
          <div className="game-board" style={{ height: '100%' }}>
`;

content = content.replace("  return (\n    <Xwrapper>\n    <div className=\"game-board\">", layoutStart);
...
const layoutEnd = `
        ...
        {/* RIGHT SIDEBAR */}
        <div className="right-sidebar" style={{ width: '350px', backgroundColor: '#111', borderLeft: '2px solid #333', display: 'flex', flexDirection: 'column', color: '#fff', fontFamily: 'Inter, sans-serif' }}>
            {/* Card Info Section */}
